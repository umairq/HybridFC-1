...
class Execute:
    def __init__(self, args):
        ...
        self.args.dataset = Data(data_dir=args.path_dataset_folder+'/',
                                 subpath=args.subpath,
                                 prop=args.prop,
                                 complete_data= args.cmp_dataset, emb_typ=args.emb_type, emb_file="", bpdp_dataset=bpdp, full_hybrid=hybrid_app)
    ...
    def training(self):
        ...
        self.trainer.test(test_dataloaders=dataset.dataloaders(len(self.args.dataset.idx_test_data)))
